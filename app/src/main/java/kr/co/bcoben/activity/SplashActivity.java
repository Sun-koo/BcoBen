...
public class SplashActivity extends AppCompatActivity {
    ...
    private String[] permission = {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO, Manifest.permission.READ_PHONE_STATE};
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        PermissionState permissionState = resultRequestPermission(this, permissions, grantResults);
